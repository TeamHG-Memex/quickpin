...
@Component(
    ...
    templateUrl: 'packages/quickpin/component/autocomplete_text.html',
    useShadowDom: false
)
class AutoCompleteTextComponent implements ShadowRootAware {
    @NgOneWay('onsave')
    Function onSave;
    ...
    /// Constructor.
    AutoCompleteTextComponent(this._element);
